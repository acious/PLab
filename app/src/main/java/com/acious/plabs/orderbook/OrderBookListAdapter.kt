...
class OrderBookListAdapter :
    ...
    inner class OrderBookVH(private val binding: ItemOrderbookLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OrderBookVH {
        return OrderBookVH(ItemOrderbookLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
